...
category: Core
created: '2022-03-05'
currently, the popular blockchain basically supports open-source monitoring [prometheus](https: //prometheus.io/),
  java-tron has its own [monitoring api](http://52.15.93.92:8090/monitor/getstatsinfo),
  but it is not compatible with `prometheus`.If you want to use the current monitoring,
  you need to build your own front-end visualization. It is very unfriendly for users
  to monitor their own nodes.
