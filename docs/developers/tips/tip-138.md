...
- Final
- Standards Track
the tip provides the pedersen hash computation function in the shielded trc-20 contract ([tip-135](https: //github.com/tronprotocol/tips/blob/master/tip-135.md)),
