...
hide:
- toc
public boolean allowreceiptsmerkleroot(): Whether to enable the function of trading
  results on the chain
public sha256hash calcreceiptsroot(): Calculate the Merkel root of all transaction
  results
public sha256hash getreceiptsmerklehash(): Get the hash value of each transaction
  result
status: Final
tags:
- Final
