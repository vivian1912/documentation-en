...
author: getty.io
created: '2017-04-05'
? currently the only way to store tron account's keys is by saving a long str-encoded
  string which represents a secret key. however many industry standards have been
  developed for deriving keys which improve key storage and moving keys between wallets.
  adapting these standards for tron accounts should improve tron wallets by
: ''
hide:
- toc
tags:
