...
hide:
- toc
? however, there is currently no standard for off-chain message signing for tron protocol,
  so this tip aims to introduce an signed data standard similar to [eip-191](https
