...
- Final
- Standards Track
the encoding function, hashing algorithm and signing algorithm are identical to [eip-712](https: '//eips.ethereum.org/EIPS/eip-712).
  There are some differences in details as follows:'
tip: '712'
