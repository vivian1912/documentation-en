...
- Final
- Meta
? the `selfdestruct` opcode has been deprecated after the ethereum shanghai upgrade
  and its behavior has been modified after the ethereum cancun upgrade. for compatibility,
  [eip-6049
: Deprecate SELFDESTRUCT](https://eips.ethereum.org/EIPS/eip-6049) is required to
  be announced in the TRON community firstly.
tip: '652'
